...
export const EditPhotoModal = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-lg p-6 shadow-xl flex flex-col gap-[30px]justify-between items-stretch text-left
          w-[343px] h-[578px]
        ...
        <div className="flex flex-col gap-4 flex-1 mt-5">
          <div className="flex flex-col gap-1.5">
            ...
            <input
              ...
              className="w-[318px] px-3 py-2 border border-text-secondary rounded focus:outline-none focus:ring-1 focus:ring-accent"
            />
          </div>
          ...
          <div className="min-h-[196px] h-auto flex flex-col gap-1.5 p-0 bg-transparent">
            ...
            <textarea
              ...
              className="w-[318px] flex-1 min-h-[160px] p-3 border border-text-secondary/50 rounded resize-none focus:outline-none focus:ring-1 focus:ring-accent"
            />
          </div>
        </div>
