...
export const ProfileSideBar = ({ onClose }: { onClose?: () => void }) => {
  ...
  return (
    ...
    <span>Gallery</span>
            ...
            {isFolderOpen ? <ChevronUp className="chevron-icon" /> : <ChevronDown className="chevron-icon"  />}
          </div>
    ...
    <span className="text-xs truncate color-text-secondary">
      ...
      <div className="absolute bottom-[40px] left-[20px] z-30"
        onClick={handleLogout}
      >
        <div className="flex items-center justify-between">
        <img src="/inbound.png" alt="Bottom" className="size-icon brightness-0 invert-[0.5]" />
